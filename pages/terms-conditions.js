    ...
    >
      <section className="section bg-inner">
        ...
        >
          ...
          <p>Welcome to SubsidyX!</p>

          <p>
            These terms and conditions outline the rules and regulations for the
            use of Jinishis Fintech Private Limiteds Website, located at
            https://www.subsidyx.com.
          </p>

          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use SubsidyX if you do not agree to
          ...
          <p>
            ...
            needs in respect of provision of the Companys stated services, in
          ...
          <p>
            We employ the use of cookies. By accessing SubsidyX, you agreed to
            use cookies in agreement with the Jinishis Fintech Private Limiteds
            Privacy Policy.{" "}
          </p>
          ...
          <p>
            Unless otherwise stated, Jinishis Fintech Private Limited and/or its
            licensors own the intellectual property rights for all material on
            SubsidyX. All intellectual property rights are reserved. You may
            access this from SubsidyX for your own personal use subjected to
            restrictions set in these terms and conditions.
          </p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from SubsidyX</li>
            <li>Sell, rent or sub-license material from SubsidyX</li>
            <li>Reproduce, duplicate or copy material from SubsidyX</li>
            <li>Redistribute content from SubsidyX</li>
          </ul>
          ...
          <p>
            ...
            Jinishis Fintech Private Limited does not filter, edit, publish or
            review Comments prior to their presence on the website. Comments do
            not reflect the views and opinions of Jinishis Fintech Private
            ...
            extent permitted by applicable laws, Jinishis Fintech Private
          ...
          <p>
            Jinishis Fintech Private Limited reserves the right to monitor all
          ...
          <p>
            You hereby grant Jinishis Fintech Private Limited a non-exclusive
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Jinishis
            Fintech Private Limited; and (d) the link is in the context of
          ...
          <p>
            ...
            sending an e-mail to Jinishis Fintech Private Limited. Please
          ...
          <p>
            No use of Jinishis Fintech Private Limiteds logo or other artwork
